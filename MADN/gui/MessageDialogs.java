...
public class MessageDialogs extends JDialog implements ActionListener, WindowListener{
	...
	private MessageDialogs(Component parent, String title, String message, String details, int icon){
		...
		Icon i = null;
		switch (icon){
			case ERROR_ICON:	i = Toolbox.loadStop24Icon(this.getClass());
								break;
			case WARNING_ICON:	i = Toolbox.loadTip24Icon(this.getClass());
								break;
			case INFO_ICON:		i = Toolbox.loadInfo24Icon(this.getClass());
								break;
		}
		...
		butDetails = new JButton("Details anzeigen", Toolbox.loadDownIcon(this.getClass()));
